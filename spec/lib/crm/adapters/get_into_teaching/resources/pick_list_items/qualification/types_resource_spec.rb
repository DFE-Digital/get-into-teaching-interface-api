...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Qualification::TypesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/qualification/types")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns TypeResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Qualification::TypeResource))
    end
