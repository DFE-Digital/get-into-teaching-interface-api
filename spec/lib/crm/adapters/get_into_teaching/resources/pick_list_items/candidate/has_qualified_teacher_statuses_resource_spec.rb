...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::HasQualifiedTeacherStatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/has_qualified_teacher_statuses")
        .to_return(
          status: 200,
          body: [
