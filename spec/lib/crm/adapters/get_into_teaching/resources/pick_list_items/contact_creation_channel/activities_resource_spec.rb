...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::ContactCreationChannel::ActivitiesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/contact_creation_channel/activities")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns ActivityResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::ContactCreationChannel::ActivityResource))
    end
