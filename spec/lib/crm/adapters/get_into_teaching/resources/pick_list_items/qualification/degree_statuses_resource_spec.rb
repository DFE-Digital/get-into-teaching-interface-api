...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Qualification::DegreeStatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/qualification/degree_status")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns DegreeStatusResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Qualification::DegreeStatusResource))
    end
