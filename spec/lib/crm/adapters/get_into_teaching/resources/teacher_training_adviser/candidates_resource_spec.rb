...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::TeacherTrainingAdviser::CandidatesResource do
  ...
  describe "#create" do
    ...
    it "returns CandidateResource instances" do
      expect(resource.create).to all(be_a(CRM::Resources::TeacherTrainingAdviser::CandidateResource))
    end
