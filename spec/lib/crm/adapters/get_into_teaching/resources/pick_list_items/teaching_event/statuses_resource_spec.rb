...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::TeachingEvent::StatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/teaching_event/status")
        .to_return(
          status: 200,
          body: [
