...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::ChannelsResource do
  ...
  describe "#all" do
    ...
    it "returns ChannelResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::ChannelResource))
    end
