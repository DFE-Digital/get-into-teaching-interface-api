...
RSpec.describe CRM::Adapters::Demo::Resources::PickListItems::CandidateResource do
  ...
  describe "#assignment_statuses" do
    it "returns a Demo PickListItems::Candidate::AssignmentStatusesResource" do
  ...
  describe "#citizenships" do
    it "returns a Demo PickListItems::Candidate::CitizenshipsResource" do
      expect(resource.citizenships).to be_a(CRM::Adapters::Demo::Resources::PickListItems::Candidate::CitizenshipsResource)
    end
  end

  describe "#visa_statuses" do
    it "returns a Demo PickListItems::Candidate::VisaStatusesResource" do
