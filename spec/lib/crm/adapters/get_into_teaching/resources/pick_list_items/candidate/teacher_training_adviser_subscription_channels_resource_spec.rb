...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::TeacherTrainingAdviserSubscriptionChannelsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/teacher_training_adviser_subscription_channels")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns TeacherTrainingAdviserSubscriptionChannelResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::TeacherTrainingAdviserSubscriptionChannelResource))
    end
