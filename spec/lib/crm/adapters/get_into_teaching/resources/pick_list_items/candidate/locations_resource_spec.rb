...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::LocationsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/locations")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns LocationResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::LocationResource))
    end
