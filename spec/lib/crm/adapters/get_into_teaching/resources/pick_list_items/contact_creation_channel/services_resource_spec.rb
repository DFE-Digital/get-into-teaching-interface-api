...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::ContactCreationChannel::ServicesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/contact_creation_channel/services")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns ServiceResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::ContactCreationChannel::ServiceResource))
    end
