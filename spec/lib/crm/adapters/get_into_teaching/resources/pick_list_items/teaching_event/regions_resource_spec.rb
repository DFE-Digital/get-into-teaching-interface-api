...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::TeachingEvent::RegionsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/teaching_event/regions")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns RegionResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::TeachingEvent::RegionResource))
    end
