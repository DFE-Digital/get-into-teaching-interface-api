...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::ConsiderationJourneyStagesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/consideration_journey_stages")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns ConsiderationJourneyStageResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::ConsiderationJourneyStageResource))
    end
