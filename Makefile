ARM_TEMPLATE_TAG=1.1.15
RG_TAGS={"Product" : "Teacher services cloud", "Service Offering" : "Teacher services cloud"}
REGION=UK South
SERVICE_NAME=get-into-teaching-interface-api
SERVICE_SHORT=gitint
DOCKER_REPOSITORY=ghcr.io/dfe-digital/get-into-teaching-interface-api
