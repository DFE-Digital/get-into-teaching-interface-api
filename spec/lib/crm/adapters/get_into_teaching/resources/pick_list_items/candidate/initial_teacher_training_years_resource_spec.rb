...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::InitialTeacherTrainingYearsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/initial_teacher_training_years")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns InitialTeacherTrainingYearResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::InitialTeacherTrainingYearResource))
    end
