...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::TeachingEvent::TypesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/teaching_event/types")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns TypeResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::TeachingEvent::TypeResource))
    end
