...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::AdviserEligibilitiesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/adviser_eligibilities")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns AdviserEligibilityResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::AdviserEligibilityResource))
    end
