...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::PreferredEducationPhasesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/preferred_education_phases")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns PreferredEducationPhaseResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::PreferredEducationPhaseResource))
    end
