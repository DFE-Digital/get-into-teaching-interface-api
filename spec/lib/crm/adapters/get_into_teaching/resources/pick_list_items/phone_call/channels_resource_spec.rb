...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::PhoneCall::ChannelsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/phone_call/channels")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns ChannelResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::PhoneCall::ChannelResource))
    end
