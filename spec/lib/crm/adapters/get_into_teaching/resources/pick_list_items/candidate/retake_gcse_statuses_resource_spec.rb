...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::RetakeGcseStatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/retake_gcse_status")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns RetakeGcseStatusResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::RetakeGcseStatusResource))
    end
