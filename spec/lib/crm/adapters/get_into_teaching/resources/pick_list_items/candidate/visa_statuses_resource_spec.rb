...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::VisaStatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/visa_statuses")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns VisaStatusResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::VisaStatusResource))
    end
