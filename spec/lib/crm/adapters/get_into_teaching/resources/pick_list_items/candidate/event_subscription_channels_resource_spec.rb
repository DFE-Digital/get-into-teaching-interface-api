...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::EventSubscriptionChannelsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/event_subscription_channels")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns EventSubscriptionChannelResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::EventSubscriptionChannelResource))
    end
