...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::CitizenshipsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/citizenships")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns CitizenshipResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::CitizenshipResource))
    end
