...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Qualification::UkDegreeGradesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/qualification/uk_degree_grades")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns UkDegreeGradeResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Qualification::UkDegreeGradeResource))
    end
