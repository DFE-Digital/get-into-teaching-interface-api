...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::AssignmentStatusesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/assignment_status")
        .to_return(
          status: 200,
          body: [
    ...
    it "returns AssignmentStatusResource instances" do
      expect(resource.all).to all(be_a(CRM::Resources::PickListItems::Candidate::AssignmentStatusResource))
    end
