...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::CandidateResource do
  ...
  describe "#situations" do
    it "returns a GIT PickListItems::Candidate::SituationsResource" do
      expect(resource.situations).to be_a(CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::SituationsResource)
    end
  end

  describe "#citizenships" do
    it "returns a GIT PickListItems::Candidate::CitizenshipsResource" do
      expect(resource.citizenships).to be_a(CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::CitizenshipsResource)
    end
  end

  describe "#visa_statuses" do
    it "returns a GIT PickListItems::Candidate::VisaStatusesResource" do
  ...
  describe "#has_qualified_teacher_statuses" do
    it "returns a GIT PickListItems::Candidate::HasQualifiedTeacherStatusesResource" do
      expect(resource.has_qualified_teacher_statuses).to be_a(CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::HasQualifiedTeacherStatusesResource)
    end
  end
end
