...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::PastTeachingPosition::EducationPhasesResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/past_teaching_position/education_phases")
        .to_return(
          status: 200,
          body: [
