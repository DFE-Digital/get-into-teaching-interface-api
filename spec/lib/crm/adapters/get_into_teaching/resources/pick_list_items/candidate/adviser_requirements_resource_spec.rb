...
RSpec.describe CRM::Adapters::GetIntoTeaching::Resources::PickListItems::Candidate::AdviserRequirementsResource do
  ...
  describe "#all" do
    before do
      stub_request(:get, "#{base_url}/api/pick_list_items/candidate/adviser_requirements")
        .to_return(
          status: 200,
          body: [
